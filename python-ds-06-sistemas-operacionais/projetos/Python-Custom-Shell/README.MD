Um código Python que implementa um terminal interativo customizado. Ele utiliza a biblioteca 
readline para oferecer preenchimento automático (Tab) de comandos e arquivos, suporte a cores ANSI, 
execução de subprocessos do sistema e navegação de diretórios, focado em produtividade e estética
